    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/zxh12345678/camera/master/source/photos' + data.link[i] + '.min.jpg';
          var src = 'https://raw.githubusercontent.com/zxh12345678/camera/master/source/min_photos' + data.link[i];
